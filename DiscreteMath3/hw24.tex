...
\begin{proof}[解答]
    ...
    考察として、
    Chernoff 限界の方は定理の適用に「$X_{i,j}$が独立であること」と「重み$l_i$が 0〜1であること」を必要とするため問題設定を活かしているのに対し、
    チェビシェフの不等式は定理の適用にそれらの条件を必要としないため定理内での評価が甘くなり、結果としてチェビシェフの不等式による評価の方が粗くなったと考えられる。
